...
bool ModeSurface::init(bool ignore_checks)
{
    ...
    position_control->set_max_speed_accel_U_cm(sub.get_pilot_speed_dn(), sub.get_pilot_speed_up(), sub.get_pilot_accel_z());
    position_control->set_correction_speed_accel_U_cm(sub.get_pilot_speed_dn(), sub.get_pilot_speed_up(), sub.get_pilot_accel_z());
