...
public:
    ...
    void set_max_speed_accel_U_cm(float vel_max_down_ms, float vel_max_up_cms, float accel_max_d_cmss);
    ...
    void set_correction_speed_accel_U_cm(float vel_max_down_cms, float vel_max_up_cms, float accel_max_d_cmss);
    ...
    void land_at_climb_rate_ms(float vel_d_ms, bool ignore_descent_limit);
