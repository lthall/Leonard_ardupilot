...
public:
    ...
    void set_lean_angle_max_deg(float angle_max_deg) { _angle_max_override_rad = radians(angle_max_deg); }

    /// Sets the maximum allowed lean angle in centidegrees (roll/pitch) for the attitude controller.
    /// See set_lean_angle_max_deg() for full details.
    void set_lean_angle_max_cd(float angle_max_cd) { _angle_max_override_rad = cd_to_rad(angle_max_cd); }
