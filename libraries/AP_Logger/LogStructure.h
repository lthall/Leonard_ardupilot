...
// @LoggerMessage: PSCN
// @Description: Position Control N-axis
// @Field: TimeUS: Time since system startup
// @Field: TPN: Target position relative to EKF origin
// @Field: PN: Position relative to EKF origin
// @Field: DVN: Desired velocity N-axis
// @Field: TVN: Target velocity N-axis
// @Field: VN: Velocity N-axis
// @Field: DAN: Desired acceleration N-axis
// @Field: TAN: Target acceleration N-axis
// @Field: AN: Acceleration N-axis

// @LoggerMessage: PSCE
// @Description: Position Control E-axis
// @Field: TimeUS: Time since system startup
// @Field: TPE: Target position relative to EKF origin
// @Field: PE: Position relative to EKF origin
// @Field: DVE: Desired velocity E-axis
// @Field: TVE: Target velocity E-axis
// @Field: VE: Velocity E-axis
// @Field: DAE: Desired acceleration E-axis
// @Field: TAE: Target acceleration E-axis
// @Field: AE: Acceleration E-axis

// @LoggerMessage: PSCD
// @Description: Position Control D-axis
// @Field: TimeUS: Time since system startup
// @Field: TPD: Target position relative to EKF origin
// @Field: PD: Position relative to EKF origin
// @Field: DVD: Desired velocity D-axis
// @Field: TVD: Target velocity D-axis
// @Field: VD: Velocity D-axis
// @Field: DAD: Desired acceleration D-axis
// @Field: TAD: Target acceleration D-axis
// @Field: AD: Acceleration D-axis
