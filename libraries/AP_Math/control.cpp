                           ...
                           float angle_jerk_max, float dt, bool limit_total)
{
    ...
    // Optional limit on correction angular velocity before adding feedforward.
    if (is_positive(angle_vel_max)) {
        angle_vel_corr_cmd = constrain_float(angle_vel_corr_cmd, -angle_vel_max, angle_vel_max);
    }
    ...
    // Constrain total angular velocity if limiting is enabled.
