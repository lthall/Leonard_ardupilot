...
public:
    ...
    AP_Float _over_current;             /// current level used to trigger an over current failsafe
    ...
    AP_Int8  _over_current_timeout;     /// timeout in seconds before an over current event will be triggered
