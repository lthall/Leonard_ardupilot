...
public:
    ...
    void init_NEU_cm(const Vector3p& center_ned_cm, bool is_terrain_alt, float rate_degs);
    ...
    void get_closest_point_on_circle_NEU_cm(Vector3f& result_ned_cm, float& dist_cm) const;
