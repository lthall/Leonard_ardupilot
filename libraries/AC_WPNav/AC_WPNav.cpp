...
bool AC_WPNav::set_wp_destination_loc(const Location& destination)
{
    ...
    return set_wp_destination_NED_m(dest_ned_m, is_terrain_alt);
}
...
bool AC_WPNav::set_wp_destination_next_loc(const Location& destination)
{
    ...
    return set_wp_destination_next_NED_m(dest_ned_m, is_terrain_alt);
}
...
bool AC_WPNav::set_wp_destination_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt)
{
    ...
    if (_flags.fast_waypoint && !_this_leg_is_spline && !_next_leg_is_spline && !_scurve_next_leg.finished()) {
        ...
        _scurve_this_leg.calculate_track(_origin_ned_m, _destination_ned_m,
...
bool AC_WPNav::set_wp_destination_next_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt)
{
    ...
    _scurve_next_leg.calculate_track(_destination_ned_m, destination_ned_m,
                                     _pos_control.get_max_speed_NE_ms(), _pos_control.get_max_speed_up_ms(), _pos_control.get_max_speed_down_ms(),
                                     get_wp_acceleration_mss(), get_accel_D_mss(),
                                     _scurve_snap_max_mssss, _scurve_jerk_max_msss);
    if (_this_leg_is_spline) {
