...
public:
    ...
    virtual bool set_wp_destination_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt = false);
    ...
    bool set_wp_destination_next_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt = false);
