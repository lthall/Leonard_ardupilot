...
public:
    ...
    bool set_wp_destination_NEU_cm(const Vector3f& destination_ned_cm, bool is_terrain_alt = false) override;
    ...
    bool set_wp_destination_NED_m(const Vector3p& destination_ned_m, bool is_terrain_alt = false) override;
