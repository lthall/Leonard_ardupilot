...
// @Field: OX: moving baseline yaw antenna offset used to calculate GPS yaw, X-axis
// @Field: OY: moving baseline yaw antenna offset used to calculate GPS yaw, Y-axis
// @Field: OZ: moving baseline yaw antenna offset used to calculate GPS yaw, Z-axis
// @Field: I: GPS sensor instance number
struct log_RGPK {
