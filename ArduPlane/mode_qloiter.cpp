...
bool ModeQLoiter::_enter()
{
    ...
    pos_control->set_max_speed_accel_U_m(quadplane.get_pilot_velocity_z_max_dn_m(), quadplane.get_pilot_velocity_z_max_up_m(), quadplane.get_pilot_accel_z_mss());
    pos_control->set_correction_speed_accel_U_m(quadplane.get_pilot_velocity_z_max_dn_m(), quadplane.get_pilot_velocity_z_max_up_m(), quadplane.get_pilot_accel_z_mss());
