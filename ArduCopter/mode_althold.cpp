...
void ModeAltHold::run()
{
    ...
    get_pilot_desired_lean_angles_rad(target_roll_rad, target_pitch_rad, copter.aparm.angle_max * radians(0.01f), attitude_control->get_althold_lean_angle_max_cd() * radians(0.01f));
    ...
    case AltHoldModeState::Flying:
        ...
        // apply avoidance
        copter.avoid.adjust_roll_pitch_rad(target_roll_rad, target_pitch_rad, copter.aparm.angle_max * radians(0.01f));
#endif
