...
void ModeAltHold::run()
{
    ...
    get_pilot_desired_lean_angles_rad(target_roll_rad, target_pitch_rad, cd_to_rad(copter.aparm.angle_max), cd_to_rad(attitude_control->get_althold_lean_angle_max_cd()));
    ...
    case AltHoldModeState::Flying:
        ...
        // apply avoidance
        copter.avoid.adjust_roll_pitch_rad(target_roll_rad, target_pitch_rad, cd_to_rad(copter.aparm.angle_max));
#endif
