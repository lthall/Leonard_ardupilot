...
void ModeFlip::run()
{
    ...
    case FlipState::Start:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(FLIP_ROTATION_RATE * radians(0.01f) * roll_dir, FLIP_ROTATION_RATE * radians(0.01f) * pitch_dir, 0.0);
    ...
    case FlipState::Roll:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(FLIP_ROTATION_RATE * radians(0.01f) * roll_dir, 0.0, 0.0);
        // decrease throttle
    ...
    case FlipState::Pitch_A:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(0.0f, FLIP_ROTATION_RATE * radians(0.01f) * pitch_dir, 0.0);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
    ...
    case FlipState::Pitch_B:
        // between 45deg ~ -90deg request 400deg/sec pitch
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(0.0, FLIP_ROTATION_RATE * radians(0.01f) * pitch_dir, 0.0);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
    ...
    case FlipState::Recover: {
        ...
        attitude_control->input_euler_angle_roll_pitch_yaw_cd(orig_attitude_rad.x, orig_attitude_rad.y, orig_attitude_rad.z, false);
        ...
        if (fabsf(recovery_angle_rad) <= FLIP_RECOVERY_ANGLE * radians(0.01f)) {
