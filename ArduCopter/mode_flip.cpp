...
void ModeFlip::run()
{
    ...
    case FlipState::Start:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(cd_to_rad(FLIP_ROTATION_RATE) * roll_dir, cd_to_rad(FLIP_ROTATION_RATE) * pitch_dir, 0.0);
    ...
    case FlipState::Roll:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(cd_to_rad(FLIP_ROTATION_RATE) * roll_dir, 0.0, 0.0);
        // decrease throttle
    ...
    case FlipState::Pitch_A:
        ...
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(0.0f, cd_to_rad(FLIP_ROTATION_RATE) * pitch_dir, 0.0);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
    ...
    case FlipState::Pitch_B:
        // between 45deg ~ -90deg request 400deg/sec pitch
        attitude_control->input_rate_bf_roll_pitch_yaw_rads(0.0, cd_to_rad(FLIP_ROTATION_RATE) * pitch_dir, 0.0);
        // decrease throttle
        throttle_out = MAX(throttle_out - FLIP_THR_DEC, 0.0f);
    ...
    case FlipState::Recover: {
        ...
        attitude_control->input_euler_angle_roll_pitch_yaw_cd(orig_attitude_euler_rad.x, orig_attitude_euler_rad.y, orig_attitude_euler_rad.z, false);
        ...
        if (fabsf(recovery_angle_rad) <= cd_to_rad(FLIP_RECOVERY_ANGLE)) {
