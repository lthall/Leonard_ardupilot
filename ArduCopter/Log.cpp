...
// vel_target is cm/s
void Copter::Log_Write_GuidedTarget(ModeGuided::SubMode target_type, const Vector3f& pos_target, bool terrain_alt, const Vector3f& vel_target, const Vector3f& accel_target, bool interpret_as_throttle)
{
    struct log_GuidedTarget pkt = {
        LOG_PACKET_HEADER_INIT(LOG_GUIDEDTARGET_MSG),
        time_us         : AP_HAL::micros64(),
        type            : (uint8_t)target_type,
        use_throttle    : interpret_as_throttle,
...
// @Field: aZ: Target acceleration, Z-Axis
    ...
    { LOG_GUIDEDTARGET_MSG, sizeof(log_GuidedTarget),
      "GUID",  "QBBfffbffffff",    "TimeUS,Type,IntTh,pX,pY,pZ,Terrain,vX,vY,vZ,aX,aY,aZ", "s--mmm-nnnooo", "F--BBB-BBBBBB" },
};
