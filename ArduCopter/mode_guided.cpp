...
void ModeGuided::pos_control_run()
{
    ...
    if (guided_is_terrain_alt) {
        pos_offset_z_buffer_m = MIN(copter.wp_nav->get_terrain_margin_m(), 0.5 * fabsF(guided_pos_target_ned_m.z));
    }
    pos_control->input_pos_NED_m(guided_pos_target_ned_m, terrain_u_m, pos_offset_z_buffer_m);
