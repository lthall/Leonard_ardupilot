...
void ModeFlowHold::run()
{
    ...
    get_pilot_desired_lean_angles_rad(bf_angles_rad.x, bf_angles_rad.y, cd_to_rad(angle_max), cd_to_rad(attitude_control->get_althold_lean_angle_max_cd()));
    ...
    bf_angles_rad.x = constrain_float(bf_angles_rad.x, -cd_to_rad(angle_max), cd_to_rad(angle_max));
    bf_angles_rad.y = constrain_float(bf_angles_rad.y, -cd_to_rad(angle_max), cd_to_rad(angle_max));
