...
bool ModeThrow::init(bool ignore_checks)
{
    ...
    pos_control->set_max_speed_accel_xy(wp_nav->get_default_speed_xy_cms(), BRAKE_MODE_DECEL_RATE);
    pos_control->set_correction_speed_accel_xy(wp_nav->get_default_speed_xy_cms(), BRAKE_MODE_DECEL_RATE);
