...
bool ModeAuto::verify_payload_place()
{
    ...
    case PayloadPlaceStateType_Calibrating_Hover: {
        ...
        gcs().send_text(MAV_SEVERITY_INFO, "payload hover throttle: %f", static_cast<double>(nav_payload_place.hover_throttle_level));
    ...
    case PayloadPlaceStateType_Ascending_Start: {
        ...
        auto_takeoff_start(target_loc.alt, target_loc.get_alt_frame() == Location::AltFrame::ABOVE_TERRAIN);
