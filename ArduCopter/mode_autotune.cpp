...
{
    copter.mode_autotune.get_pilot_desired_lean_angles_rad(des_roll_rad, des_pitch_rad, cd_to_rad(copter.aparm.angle_max),
                                                       cd_to_rad(copter.attitude_control->get_althold_lean_angle_max_cd()));
    yaw_rate_rads = copter.mode_autotune.get_pilot_desired_yaw_rate();
}
